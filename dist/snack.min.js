	...
	keyboard = {
		...
		togglePress: function(b) {
			if (2 <= bricks.data.length) {
				...
				switch (b) {
					case 'up':
						if (0 < a || 0 > a || 0 > c) this.isUpPress = !this.isUpPress;
						break;
					case 'down':
						if (0 < a || 0 > a || 0 < c) this.isDownPress = !this.isDownPress;
						break;
					case 'left':
						if (0 > a || 0 > c || 0 < c) this.isLeftPress = !this.isLeftPress;
						break;
					case 'right':
						if (0 < a || 0 > c || 0 < c) this.isRightPress = !this.isRightPress;
				}
			} else
				switch (b) {
					case 'up':
